...
class FindFileTest : public testing::Test {
 public:
  ...
  void Add(const char* smallest, const char* largest,
    ...
    SSTableDescriptor* f = new SSTableDescriptor;
 ...
 private:
  std::vector<SSTableDescriptor*> files_;
};
...
class AddBoundaryInputsTest : public testing::Test {
 public:
  std::vector<SSTableDescriptor*> level_files_;
  std::vector<SSTableDescriptor*> compaction_files_;
  std::vector<SSTableDescriptor*> all_files_;
  ...
  SSTableDescriptor* CreateFileMetaData(uint64_t number, InternalKey smallest,
                                   InternalKey largest) {
    SSTableDescriptor* f = new SSTableDescriptor();
    f->number = number;
    f->smallest = smallest;
